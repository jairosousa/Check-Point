...
import { ControleComponent } from 'app/entities/controle/controle.component';
...
describe('Component Tests', () => {
    describe('Controle Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.controles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
